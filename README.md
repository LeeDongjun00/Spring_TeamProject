...
<img src="./images/schedule_add.png" alt="코스 추천 및 편집" style="border: 5px solid black;">

### 3️⃣ 경로 시각화 및 최종 동선 확인
선택된 장소들 간의 최단 경로를 **Kakao Map API**로 탐색하여 총 이동 거리와 예상 소요 시간을 실시간으로 산출합니다.

<img src="./images/schedule_checkCar.png" alt="여행 경로 지도" style="border: 5px solid black;">
...
<img src="./images/reservation_acc.png" alt="숙소 상세 예약" style="border: 5px solid black;">
